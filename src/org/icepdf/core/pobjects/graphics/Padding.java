...
public class Padding {
	 ...
	 * (byte) 0xD, (byte) 0x32, (byte) 0x63, (byte) 0x4E, (byte) 0x59, (byte) 0x62,
	 * (byte) 0x4E, (byte) 0x61, (byte) 0x56, (byte) 0x5C, (byte) 0x5B, (byte) 0xD,
	 * (byte) 0x3D, (byte) 0x62, (byte) 0x5F, (byte) 0x5D, (byte) 0x5C, (byte) 0x60,
	 * (byte) 0x52, (byte) 0x60, (byte) 0xD, (byte) 0x3C, (byte) 0x5B, (byte) 0x59,
	 * (byte) 0x66 };
	 */
	...
	public static final void getPadding(final Graphics2D g2, final Rectangle2D.Float mediaBox) {
		...
		Rectangle2D fontBounds = fontMetrics.getStringBounds(footerText.toCharArray(), 0, footerText.length(), g2);
		int x = (int) (mediaBox.x + (mediaBox.width - fontBounds.getWidth()) / 2.0);
		int y = -1 * (int) (mediaBox.getY() - mediaBox.getHeight() + marginPadding);
		g2.drawString(footerText, x, y);

		// draw header
		fontBounds = fontMetrics.getStringBounds(headerText.toCharArray(), 0, headerText.length(), g2);
